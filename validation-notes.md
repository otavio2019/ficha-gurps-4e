...
- Em 1280 × 720 e 375 × 812, “Nova missão” foi criada e excluída com sucesso. Nas mesmas duas larguras, “Novo conteúdo” foi criado na biblioteca Homebrew e removido pelo controle individual, sem overflow horizontal.
- Em 1280 × 720 e 375 × 812, as dez abas principais foram abertas sequencialmente. Em desktop, a barra lateral ativou cada painel; em celular, o seletor de abas ativou os mesmos dez painéis. Não houve overflow horizontal em nenhuma troca.
- A exportação JSON baixou um arquivo de esquema 1.0 com personagem, atributos, inventário, poderes e cálculos. A exportação para PDF acionou a impressão e gerou A4 de três páginas. A composição impressa foi corrigida para permitir a distribuição da seção ativa entre páginas: a primeira página agora reúne cabeçalho, Visão geral e identidade, sem a área vazia inicial.
- A checagem programática do PDF confirmou que a página 1 contém “Novo personagem”, “Visão geral” e “Origem e herança”; a extração retornou 634 bytes de texto, comprovando que o cabeçalho e conteúdo relevante da ficha permanecem na primeira folha.
- Em 1280 × 720 e 375 × 812, “Novo aliado” foi criado com êxito; todas as seis abas internas — Visão geral, Atributos, Características, Perícias, Combate e Inventário — foram abertas sem overflow. Na aba Combate, o controle Dano alterou PV de 10/10 para 9/10 nos dois cenários.
- Em 1280 × 720 e 375 × 812, o retrato padrão carregou corretamente. A aba Combate exibiu o mapa corporal e as 11 regiões de proteção; a seleção mudou de Tronco para Cabeça sem overflow horizontal.
- Em uma ficha local isolada, a descrição do item principal e a descrição do item de Aliado foram preservadas no JSON exportado. PDFs gerados com as abas Equipamento e Inventário do Aliado ativas também continham, respectivamente, “Descrição da lâmina na exportação.” e “Descrição da mochila de aliado na exportação.”.
- Em 375 × 812, as dez abas principais foram revalidadas sem overflow. Os controles visíveis em cada painel passaram a usar ao menos 10,24 px; foram ampliados os atalhos de PV/PF, regiões corporais e filtros Homebrew, além dos controles residuais de Poderes e criação Homebrew.
- Uma checagem local consolidada percorreu as dez abas. Ela confirmou: PV de 10 para 9 na Visão geral; região corporal e condição no Combate; poder disponível com FP de 10/10 para 9/10; total de vantagem +5; perícia com NH calculado 9; item e carga; aliado com seis abas internas; missão com dificuldade Média; editor Homebrew em Regra; e ação recente registrada no Diário.
- A validação local de Poderes criou um poder de cada tipo. Em desktop e 375 × 812, Ofensivo, Defensivo, Controle e Utilidade apareceram como quatro grupos independentes no painel de Poderes e no Combate, sem overflow. A ativação consumiu FP de 10 para 9 e mostrou resultado 3d6. Uma nova recarga do navegador preservou PV 9, a descrição de equipamento e a descrição do inventário de Aliado.
